...
'''
roble=ArbolBinario(10)
insertarIzquierdo(roble,20)
insertarDerecho(roble,30)
l1=obtenerHijoIzquierdo(roble)
insertarIzquierdo(l1,20)
insertarDerecho(l1,20)

print ("EL roble es el siguiente")
print(roble)
